...
export class FightAudio {
 ...
 else if(kind==='swing-palm')noise(900,.12,.18,0,'highpass');
 else if(kind==='swing-kick')noise(900,.15,.24,0,'highpass');
else if(kind==='palm'){tone(85,38,.16,.65);noise(220,.10,.40,0,'lowpass');noise(2100,.045,.46);noise(950,.14,.30,.03);noise(150,.2,.24,.04,'lowpass');}
