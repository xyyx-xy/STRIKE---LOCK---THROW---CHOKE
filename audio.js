...
export class FightAudio {
 ...
 else if((kind==='swing-palm'||kind==='swing-punch'||kind==='swing-hook'||kind==='swing-uppercut'))noise(900,.12,.18,0,'highpass');
 else if((kind==='swing-kick'||kind==='swing-snapKick'))noise(900,.15,.24,0,'highpass');
else if((kind==='palm'||kind==='punch'||kind==='hook'||kind==='uppercut')){tone(85,38,.16,.65);noise(220,.10,.40,0,'lowpass');noise(2100,.045,.46);noise(950,.14,.30,.03);noise(150,.2,.24,.04,'lowpass');}
  else if((kind==='kick'||kind==='snapKick')){tone(85,32,.22,.85);noise(220,.13,.52,0,'lowpass');noise(1100,.065,.38);tone(62,25,.2,.20,.025);noise(950,.18,.34,.05);noise(120,.28,.3,.06,'lowpass');}
